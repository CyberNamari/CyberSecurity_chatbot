...
namespace CyberSecurity_chatbot
{
    public class chats
    {
        ...
        {//
            ...
            answers.Add("password must be 8 characters long");
            answers.Add("phishing dont click on the link sent");
            answers.Add("Always enable multi-factor authentication for extra security");
            answers.Add("Update your antivirus software regularly to stay protected");
            answers.Add("Avoid using public Wi-Fi for sensitive transactions");
            answers.Add("Never share your login credentials with anyone");
            answers.Add("Check for HTTPS before entering personal information on websites");
            answers.Add("Report suspicious emails to your IT/security team");
            answers.Add("Use strong, unique passwords for each account");
            answers.Add("Set up alerts for unusual account activity");
            answers.Add("Back up your important files regularly");
            answers.Add("Keep your operating system and apps updated");
            answers.Add("Be cautious of links and attachments in emails");
            answers.Add("Secure your home Wi-Fi with WPA3 and a strong password");
            answers.Add("Consider freezing your credit if you suspect identity theft");
        ...
        private Boolean end_chat(string question)
        {
            ...
            else
            {
                ...
                foreach (string words in find_words)
                {
                    ...
                    //then check what to ignor and get answer
                    foreach (string find_answer in answers)
                    {
                        ...
                        if (find_answer.Contains(words.ToLower()) && !ignoring.Contains(words))
                        {
                            ...
                            found = true;   //mark we found the answer
                        }
                    }
                }
                if(!found)
                {
                    Console.WriteLine("CyberSecuritybot: I dont understand, have another attempt");
                }
